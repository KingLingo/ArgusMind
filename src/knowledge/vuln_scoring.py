...
VULN_TYPE_CODES: Dict[str, str] = {
    ...
    "MISSING_ACCESS_CONTROL": "ACL",
    "RESOURCE_LEAK": "LEAK",
    "PLAINTEXT_PASSWORD_STORAGE": "PASS",
    "INSECURE_CIPHER_MODE": "CRYPTO",
    "INSECURE_SCRIPT_EXECUTION": "CMD",
    "SIGN_VERIFICATION_BYPASS": "CRYPTO",
    "HARDCODED_SECRETS": "PASS",
    "HARDCODED_CREDENTIAL": "PASS",
    "HARDCODED_CREDENTIALS": "PASS",
    "CREDENTIALS_IN_URL": "PASS",
    "INFORMATION_EXPOSURE": "INFO",
    "INFORMATION_LEAK": "INFO",
    "INFORMATION_LEAKAGE": "INFO",
    "PERMISSION_BYPASS": "AUTH",
    "PARAMETER_TAMPERING": "LOGIC",
    "MASS_ASSIGNMENT": "MASS",
    "IDEMPOTENCY": "LOGIC",
    "HTTP_HEADER_INJECTION": "CRLF",
    "RESOURCE_EXHAUSTION": "MEM",
